...
CurrentExperiment = {
    ...
    loop: function(loopTime, pauseTotal){
        ...
        CurrentExperiment.timeout = setTimeout(function(){
            ...
            var currentRecs = Phases.saveExperimentState(pauseTotal || null, sortByQuietest);
            ...
            Phases.checkGettingQuieterAndScore();

            var metGoal = Phases.hasLoudnessDecreased(currentRecs);
