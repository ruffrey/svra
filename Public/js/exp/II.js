...
CurrentExperiment = {
    ...
    /** 
     * At what percentage of original oudess does participant need to be before starting extinction? 
     */
    extinctionMultiplier: .75,

    /** 
     * An override max for how quiet the participant needs to be before starting extinction. 
     */
    extinctionMaxMagnitude: 120,
    ...
    loop: function(loopTime, pauseTotal){
        ...
        CurrentExperiment.timeout = setTimeout(function(){
            ...
            // Portion 2
                ...
                {
                    console.log('Was quieter than 5th highest of last 19. intervalValueForComparison:', intervalValueForComparison, 'is greater than current:', currentIntervalLoudest);
                ...
                // if it's not getting louder, beep should not play or increment
                    ...
                    console.log('Not enough quieter to give a score. intervalValueForComparison:',
                        intervalValueForComparison, 'is less than current:',
                        currentIntervalLoudest);
                }
            }
           ...
           firstPortionAverage = firstPortionTotal / firstPortionRecs.length;
             ...
             */
            if(twoMinutesHavePassed && loudnessHasSufficientlyDecreased)
            {
                console.log("Starting Extinction because: twoMinutesHavePassed and loudnessHasSufficientlyDecreased", loudnessCutoffForExinction, 'mag to', valuesToDetermineExtinction);
            ...
            else if(CurrentExperiment.totalTime >= CurrentExperiment.maxDuration )
            {
                ...
                console.log("Looping. Not quiet enough for extinction yet. Extinction at:", loudnessCutoffForExinction, 'values are', valuesToDetermineExtinction);
                CurrentExperiment.loop();
            }
